                    ...
                    <div class="col-6 col-md-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-inline mb-2">
                                    <label for="txtJasaPengiriman" class="mr-2">Jasa Pengiriman</label>
                                    <select class="custom-select form-control" name="jasaPengiriman">
                                        <option selected>Pilih Jasa</option>
                                        <option value="1">One | Rp.</option>
                                        <option value="2">Two | Rp.</option>
                                    </select>
                                </div>
                                <p class="mt-5 h5 text-center">Total Harga</p>
                                <div class="card">
                                    <div class="card-body">
