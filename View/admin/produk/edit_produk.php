    ...
    <div class="container mt-5 sticky-top" style="top: 55px;">
        <div class="card text-center mt-3 border border-light" style="width: 100%;">
            <h5 class="card-header text-light bg-primary">
                <div class="row">
                    <div class="col-4">
                        <a href="../../admin/produk/index.html" class="btn btn-light float-left">Kembali</a>
                    </div>
                                ...
                                <div class="form-group row mt-2">
                                    ...
                                    <div class="col-sm-8 mb-2">
                                        <div class="form-group">
                                            <textarea class="form-control" name="deskripsi" id="inputDeskripsi" value="" rows="3"></textarea>
                                        </div>
                                    </div>
                                    <label for="inputHarga" class="col-sm-4 col-form-label">Masukkan Harga</label>
                                    <div class="col-sm-8 mb-2">
                                        <input type="text" class="form-control" name="harga" id="inputHarga" value="">
                                    </div>
