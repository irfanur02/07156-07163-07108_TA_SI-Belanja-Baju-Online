...
<body>
            ...
            <ul class="list-group list-group-flush">
                <li class="list-group-item text-dark font-weight-bold">
                    <div class="row">
                        ...
                        <div class="col-4">
                            <a href="../../admin/produk/tambah_produk.html"
            ...
            <div class="container">
                <div class="d-flex flex-wrap justify-content-center">
                    <div class="card mb-4" style="width: 12rem;">
                        <img class="card-img-top img-thumbnail" src="../../../assets/img/casual 1.jpg"
                            alt="Card image cap">
                        <div class="card-body">
    ...
    <div class="modal fade bd-example-modal-lg" id="modalCariProduk" tabindex="-1" role="dialog"
        aria-labelledby="modalLabelCariProduk" aria-hidden="true">
                ...
                <form action="" method="post">
                    <div class="modal-body">
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="produk" id="inputProduk"
                        ...
                        <div class="form-group row mt-2">
                            ...
                            <div class="col-sm-10 mb-2">
                                <input type="text" class="form-control" name="warna" id="inputWarna"
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="custom-control custom-checkbox float-right">
                                    <input type="checkbox" class="custom-control-input" name="terlaris"
                                        id="inputTerlaris">
                            ...
                            <div class="col">
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input" name="disukai"
                                        id="inputDisukai">
