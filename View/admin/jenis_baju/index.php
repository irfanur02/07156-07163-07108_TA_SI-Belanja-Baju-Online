            ...
            <ul class="list-group list-group-flush">
                <li class="list-group-item text-dark font-weight-bold">
                    <div class="row">
                        ...
                        <div class="col-4">
                            <a href="index.php?view=admin&page=jenisBaju&aksi=tambah" class="btn btn-success btn-sm float-right mb-3">
                                Tambah Data
                            </a>
                            <button class="btn btn-dark btn-sm mb-3" data-toggle="collapse" data-target="#collapseCariJenisBaju" aria-expanded="true" aria-controls="collapseOne">
                                Cari
                            </button>
                        </div>
                    </div>
