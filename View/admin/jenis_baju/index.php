...
<head>
    ...
    <title>Manajemen Jenis Baju</title>
</head>
            ...
            <ul class="list-group list-group-flush">
                <li class="list-group-item text-dark font-weight-bold">
                    <div class="row">
                        ...
                        <div class="col-4">
                            <a href="../../admin/jenis_baju/tambah_jenis_baju.html"
                                class="btn btn-success btn-sm float-right mb-3">
                                Tambah Data
                            </a>
                            <button class="btn btn-dark btn-sm mb-3" data-toggle="collapse"
                                data-target="#collapseCariJenisBaju" aria-expanded="true" aria-controls="collapseOne">
                                Cari
                            </button>
                        </div>
                    </div>
                    <div id="accordion">
                        <div class="card">
                            <div id="collapseCariJenisBaju" class="collapse" aria-labelledby="headingOne"
                                ...
                                <form action="" method="post">
                                    <div class="card-body bg-dark text-white font-weight-normal">
                                        <div class="row">
                                            <div class="col-10">
                                                <div class="row">
                                                    <label for="inputJenisBaju" class="col-sm-5 col-form-label">Cari
                                                        Jenis Baju</label>
                                                    <div class="col-sm-5">
                ...
                <table class="table table-hover table-bordered">
                    <thead class="thead-dark text-center">
                        <tr>
                            ...
                            <th scope="col" style="width: 70%;">Jenis Baju</th>
                    ...
                    <tbody class="bg-light">
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="../../admin/jenis_baju/edit_jenis_baju.html" class="btn btn-warning"><i
