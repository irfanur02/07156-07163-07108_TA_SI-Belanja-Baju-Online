...
<body>
    ...
    <div class="container mt-5 sticky-top" style="top: 55px;">
        <div class="card text-center mt-3 border border-light" style="width: 100%;">
            <h5 class="card-header text-light bg-primary">
                <div class="row">
                    <div class="col-4">
                        <a href="index.php?view=admin&page=jenisBaju&aksi=view" class="btn btn-light float-left">Kembali</a>
                    </div>
    ...
    <div class="container" style="margin-top: 20px;">
        <div class="jumbotron jumbotron-fluid">
            <div class="container">
                <form action="index.php?view=admin&page=jenisBaju&aksi=store" method="post">
                    <div class="row justify-content-center">
                        <div class="col-8">
                            <div class="form-group row justify-content-center">
                                <label for="inputTambahJenisBaju" class="col-sm-3 col-form-label">Masukkan Jenis
                                    Baju</label>
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" name="jenis" id="inputTambahJenisBaju" placeholder="Masukkan Jenis Baju">
                                </div>
