        ...
        <div class="card text-center mt-3 border border-light" style="width: 100%;">
            ...
            <ul class="list-group list-group-flush">
                <li class="list-group-item text-dark font-weight-bold">
                    <div class="row">
                        <div class="col-4">
                            <span class="float-left">Total : <?php echo $jumlah; ?> Merek</span>
                        </div>
                        <div class="col-4">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-5">
                                                        <select class="custom-select" name="merek">
                                                            <option selected>Merek Baju</option>
                                                            <?php foreach ($dataMerekBaju as $rowDataMerekBaju) : ?>
                                                                <option><?php echo $rowDataMerekBaju['merekBaju']; ?></option>
                                                            <?php endforeach; ?>
                                                        </select>
                                                    </div>
                                                </div>
            ...
            <div class="container">
                <table class="table table-hover table-bordered">
                    ...
                    <tbody class="bg-light">
                        <?php $no = 1;
                        foreach ($dataMerekBaju as $rowDataMerekBaju) : ?>
                            <tr>
                                <th scope="row" class="text-center"><?php echo $no++; ?>.</th>
                                <td><?php echo $rowDataMerekBaju['merekBaju']; ?></td>
                                <td class="text-center">
                                    <a href="index.php?view=admin&page=merekBaju&aksi=edit&id=<?php echo $rowDataMerekBaju['idMerekBaju']; ?>" class="btn btn-warning"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
