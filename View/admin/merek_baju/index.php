            ...
            <ul class="list-group list-group-flush">
                <li class="list-group-item text-dark font-weight-bold">
                    <div class="row">
                        ...
                        <div class="col-4">
                            <a href="../../admin/merek_baju/tambah_merek_baju.html"
                                class="btn btn-success btn-sm float-right mb-3">
                                Tambah Data
                            </a>
                            <button class="btn btn-dark btn-sm mb-3" data-toggle="collapse"
                                data-target="#collapseCariMerekBaju" aria-expanded="true" aria-controls="collapseOne">
                                Cari
                            </button>
                        </div>
                    </div>
                    <div id="accordion">
                        <div class="card">
                            <div id="collapseCariMerekBaju" class="collapse" aria-labelledby="headingOne"
                    ...
                    <tbody class="bg-light">
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="../../admin/merek_baju/edit_merek_baju.html" class="btn btn-warning"><i
