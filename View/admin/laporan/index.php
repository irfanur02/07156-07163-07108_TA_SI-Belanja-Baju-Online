...
<body>
    ...
    <div class="container mt-5 sticky-top" style="top: 53px;">
        <div class="card text-center mt-3 border border-light" style="width: 100%;">
            <h5 class="card-header text-light bg-primary">Laporan</h5>
                            ...
                            <div class="card-body bg-light text-dark font-weight-normal">
                                <div class="row">
                                    ...
                                    <div class="col-9">
                                        ...
                                        <form action="" method="post" id="laporanSeluruhTransaksi">
                                            <div class="row">
                                                <div class="col">
                                                    Periode Tanggal
                                                    <div class="form-row mt-1">
                                                        <div class="col-6">
                                                            <input type="date" name="tglAwal" id="inputTglAwal" class="form-control">
                                                        </div>
                                                        <div class="col-6">
                                                            <input type="date" name="tglAkhir" id="inputTglAkhir" class="form-control">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col">
                                                    <div class="custom-control custom-checkbox">
                                                        <input type="checkbox" class="custom-control-input" id="cbTotPemTertinggi1" name="totPemTertinggi1">
                                                        <label class="custom-control-label float-left" for="cbTotPemTertinggi1">Urutkan
                                        ...
                                        <form action="" method="post" id="laporanTransaksiTiapUser">
                                            <div class="row">
                                                <div class="col">
                                                    <div class="custom-control custom-checkbox">
                                                        <input type="checkbox" id="cbCariUser" name="transaksiTiapUser" class="custom-control-input">
                                                        <label class="custom-control-label float-left" for="cbCariUser">
                                                ...
                                                <div class="col">
                                                    <div class="custom-control custom-checkbox">
                                                        <input type="checkbox" class="custom-control-input" id="cbTotPemTertinggi2" name="totPemTertinggi2">
                                                        <label class="custom-control-label float-left" for="cbTotPemTertinggi2">Urutkan
                                                            Berdasarkan Transaksi Terbanyak
                                                        </label>
                                                    </div>
                                                </div>
                ...
                <table class="table table-hover table-bordered">
                    <thead class="thead-dark text-center">
                        <tr>
                            ...
                            <th scope="col" style="width: 20%;">Jumlah Transaksi</th>
                    ...
                    <tbody class="bg-light">
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="../../admin/laporan/laporan_tiap_user.html" class="btn btn-warning">Detail</a>
                            </td>
                        </tr>
                    </tbody>
                </table>
