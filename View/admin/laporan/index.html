    ...
    <div class="container mt-5 sticky-top" style="top: 53px;">
        <div class="card text-center mt-3 border border-light" style="width: 100%;">
            ...
            <div class="card-body text-dark font-weight-bold" style="overflow-x: auto;">
                <div class="row">
                    <div class="col-3">
                        <button class="btn btn-dark btn-sm btn-block mb-3" data-toggle="collapse"
                            data-target="#collapseCariKota" aria-expanded="true" aria-controls="collapseOne">Filter
                            Laporan
                        </button>
                    </div>
                </div>
                <div id="accordion">
                    <div class="card border border-dark rounded">
                        <div id="collapseCariKota" class="collapse" aria-labelledby="headingOne"
                                    ...
                                    <div class="col-9">
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    ...
                                                    <div class="form-row mt-1">
                                                        <div class="col-6">
                                                            <input type="date" name="tglAwal" id="inputTglAwal"
                                                                class="form-control">
                                                        </div>
                                                        <div class="col-6">
                                                            <input type="date" name="tglAkhir" id="inputTglAkhir"
                                                                class="form-control">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col">
                                                    <div class="custom-control custom-checkbox">
                                                        <input type="checkbox" class="custom-control-input"
                                                            id="cbTotPemTertinggi1" name="totPemTertinggi1">
                                                        <label class="custom-control-label float-left"
                                                            for="cbTotPemTertinggi1">Urutkan
                                        ...
                                        <form action="" method="post" id="laporanTransaksiTiapUser">
                                            <div class="row">
                                                <div class="col">
                                                    <div class="custom-control custom-checkbox">
                                                        <input type="checkbox" id="cbCariUser" name="transaksiTiapUser"
                                                ...
                                                <div class="col">
                                                    <div class="custom-control custom-checkbox">
                                                        <input type="checkbox" class="custom-control-input"
                                                            id="cbTotPemTertinggi2" name="totPemTertinggi2">
                                                        <label class="custom-control-label float-left"
                                                            for="cbTotPemTertinggi2">Urutkan
                                                            Berdasarkan Transaksi Terbanyak
                                                        </label>
                                                    </div>
                                                </div>
