...
<body>
    ...
    <div class="container mt-5 sticky-top" style="top: 55px;">
        <div class="card text-center mt-3 border border-light" style="width: 100%;">
            <h5 class="card-header text-light bg-primary">
                <div class="row">
                    <div class="col-4">
                        <a href="index.php?view=admin&page=kota&aksi=view" class="btn btn-light float-left">Kembali</a>
                    </div>
                    <div class="col-4 align-middle">Edit Kota</div>
                </div>
            </h5>
        </div>
    </div>
    ...
    <div class="container" style="margin-top: 20px;">
        <div class="jumbotron jumbotron-fluid">
            <div class="container">
                <form action="index.php?view=admin&page=kota&aksi=update" method="post">
                    <input type="hidden" class="form-control" name="idKota" id="inputEditKota" value="<?php echo $dataKota['id_kota']; ?>">
                    <div class="row justify-content-center">
                        <div class="col-8">
                            <div class="form-group row justify-content-center">
                                <label for="inputEditKota" class="col-sm-3 col-form-label">Masukkan Kota</label>
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" name="kota" id="inputEditKota" value="<?php echo $dataKota['nama_kota']; ?>">
                                </div>
