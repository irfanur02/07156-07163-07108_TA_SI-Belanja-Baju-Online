...
<body>
    ...
    <div class="container mt-5 sticky-top" style="top: 55px;">
        <div class="card text-center mt-3 border border-light" style="width: 100%;">
            <h5 class="card-header text-light bg-primary">
                <div class="row">
                    <div class="col-4">
                        <a href="index.php?view=admin&page=kurir&aksi=view" class="btn btn-light float-left">Kembali</a>
                    </div>
                    <div class="col-4 align-middle">Tambah Jasa Kurir</div>
                </div>
            </h5>
        </div>
    </div>
    ...
    <div class="container" style="margin-top: 20px;">
        <div class="jumbotron jumbotron-fluid">
            <div class="container">
                <form action="index.php?view=admin&page=kurir&aksi=store" method="post">
                    <div class="row justify-content-center">
                        <div class="col-11">
                            <div class="form-group row justify-content-center">
                                <label for="inputTambahJasaKurir" class="col-sm-3 col-form-label">Masukkan Jasa
                                    Kurir</label>
                                <div class="col-sm-3">
                                    <input type="text" class="form-control" name="jasaKurir" id="inputTambahJasaKurir" placeholder="Masukkan Jasa Kurir">
                                </div>
                                <label for="inputTambahBiaya" class="col-sm-3 col-form-label">Masukkan Biaya
                                    (Rp.)</label>
                                <div class="col-sm-2">
                                    <input type="text" class="form-control" name="biaya" id="inputTambahBiaya" placeholder="Masukkan Biaya">
                                </div>
