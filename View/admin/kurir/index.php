        ...
        <div class="card text-center mt-3 border border-light" style="width: 100%;">
            ...
            <div class="card-body text-dark font-weight-bold" style="overflow-x: auto;">
                <div class="row">
                    ...
                    <div class="col-4">
                        <a href="../../admin/kurir/tambah_kurir.html" class="btn btn-success btn-sm float-right mb-3">
                            Tambah Data
                        </a>
                    ...
                    <tbody class="bg-light">
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="../../admin/kurir/edit_kurir.html" class="btn btn-warning"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</a>
                            </td>
                        </tr>
                        <tr>
                            <th scope="row" class="text-center">1.</th>
