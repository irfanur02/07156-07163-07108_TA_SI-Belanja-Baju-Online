...
<head>
    ...
    <title>Edit Status Pembelian</title>
</head>
...
<body>
        ...
        <div class="card text-center mt-3 border border-light" style="width: 100%;">
            <h5 class="card-header text-light bg-primary">
                <div class="row">
                    ...
                    <div class="col-4 align-middle">Edit Status Pembelian</div>
                </div>
            </h5>
        </div>
    </div>
    ...
    <div class="container" style="margin-top: 20px;">
        <div class="jumbotron jumbotron-fluid">
            <div class="container">
                <form action="index.php?view=admin&page=statusPembelian&aksi=update" method="post">
                    <div class="row justify-content-center">
                        <div class="col-10">
                            <div class="form-group row justify-content-center">
                                <label for="inputEditStatusPembelian" class="col-sm-4 col-form-label">Masukkan Status
                                    Pembelian</label>
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" name="statusPembelian" id="inputEditStatusPembelian" values="">
                                </div>
