...
<head>
    ...
    <title>Manajemen Ukuran Baju</title>
</head>
        ...
        <div class="card text-center mt-3 border border-light" style="width: 100%;">
            ...
            <ul class="list-group list-group-flush">
                <li class="list-group-item text-dark font-weight-bold">
                    <div class="row">
                        <div class="col">
                            <span>Manajemen Ukuran Baju</span>
                            <a href="../../admin/ukuran_baju/tambah_ukuran_baju.html"
                ...
                <table class="table table-hover table-bordered">
                    <thead class="thead-dark text-center">
                        <tr>
                            ...
                            <th scope="col" style="width: 70%;">Ukuran Baju</th>
                    ...
                    <tbody class="bg-light">
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="../../admin/ukuran_baju/edit_ukuran_baju.html" class="btn btn-warning"><i
