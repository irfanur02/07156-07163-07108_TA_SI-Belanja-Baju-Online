                ...
                <li class="list-group-item text-dark font-weight-bold">
                    <div class="row">
                        <div class="col">
                            ...
                            <a href="../../admin/ukuran_baju/tambah_ukuran_baju.html" class="btn btn-success btn-sm float-right mb-3">
                                Tambah Data
                            </a>
                        </div>
                    </div>
                    ...
                    <tbody class="bg-light">
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="../../admin/ukuran_baju/edit_ukuran_baju.html" class="btn btn-warning"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</a>
                            </td>
                        </tr>
                        <tr>
                            <th scope="row" class="text-center">1.</th>
