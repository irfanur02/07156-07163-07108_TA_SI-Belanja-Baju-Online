...
<head>
    ...
    <title>Tambah Ukuran Baju</title>
</head>
...
<body>
        ...
        <div class="card text-center mt-3 border border-light" style="width: 100%;">
            <h5 class="card-header text-light bg-primary">
                <div class="row">
                    ...
                    <div class="col-4 align-middle">Tambah Ukuran Baju</div>
                </div>
            </h5>
        </div>
    </div>
    ...
    <div class="container" style="margin-top: 20px;">
        <div class="jumbotron jumbotron-fluid">
            <div class="container">
                <form action="index.php?view=admin&page=ukuranBaju&aksi=store" method="post">
                    <div class="row justify-content-center">
                        <div class="col-9">
                            <div class="form-group row justify-content-center">
                                <label for="inputTambahUkuranBaju" class="col-sm-3 col-form-label">Masukkan Ukuran
                                    Baju</label>
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" name="ukuran" id="inputTambahUkuranBaju" placeholder="Masukkan Ukuran Baju">
                                </div>
