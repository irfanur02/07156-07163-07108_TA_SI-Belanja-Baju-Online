...
<head>
    ...
    <title>Edit Kategori Baju</title>
</head>
...
<body>
    ...
    <div class="container mt-5 sticky-top" style="top: 55px;">
        <div class="card text-center mt-3 border border-light" style="width: 100%;">
            <h5 class="card-header text-light bg-primary">
                <div class="row">
                    <div class="col-4">
                        <a href="index.php?view=admin&page=kategoriBaju&aksi=view" class="btn btn-light float-left">Kembali</a>
                    </div>
                    <div class="col-4 align-middle">Edit Kategori Baju</div>
                </div>
            </h5>
        </div>
    </div>
    ...
    <div class="container" style="margin-top: 20px;">
        <div class="jumbotron jumbotron-fluid">
            <div class="container">
                <form action="index.php?view=admin&page=kategoriBaju&aksi=update" method="post">
                    <input type="hidden" class="form-control" name="idKategori" id="inputEditKategoriBaju" value="<?php echo $dataKategoriBaju['id_kategori_baju']; ?>">
                    <div class="row justify-content-center">
                        <div class="col-9">
                            <div class="form-group row justify-content-center">
                                <label for="inputEditKategoriBaju" class="col-sm-3 col-form-label">Masukkan Kategori
                                    Baju</label>
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" name="kategori" id="inputEditKategoriBaju" value="<?php echo $dataKategoriBaju['nama_kategori_baju']; ?>">
                                </div>
