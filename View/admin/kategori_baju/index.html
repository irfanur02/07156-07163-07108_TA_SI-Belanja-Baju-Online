        ...
        <div class="card text-center mt-3 border border-light" style="width: 100%;">
            ...
            <div class="card-body text-dark" style="overflow-x: auto;">
                <div class="row flex-row flex-nowrap">
                    <div class="col-3">
                        <a href="../../admin/produk/index.html"
                            class="btn btn-outline-primary btn-block btn-sm">Produk</a>
                    </div>
                    <div class="col-3">
                        <a href="../../admin/jenis_baju/index.html"
                            class="btn btn-outline-primary btn-block btn-sm">Jenis Baju</a>
                    </div>
                    <div class="col-3">
                        <a href="../../admin/kategori_baju/index.html"
                            class="btn btn-outline-primary btn-block btn-sm">Kategori Baju</a>
                    </div>
                    <div class="col-3">
                        <a href="../../admin/merek_baju/index.html"
                            class="btn btn-outline-primary btn-block btn-sm">Merek Baju</a>
                    </div>
                    <div class="col-3">
                        <a href="../../admin/ukuran_baju/index.html"
                            class="btn btn-outline-primary btn-block btn-sm">Ukuran Baju</a>
                    </div>
                </div>
            </div>
            <ul class="list-group list-group-flush">
                <li class="list-group-item text-dark font-weight-bold">
                    <div class="row">
                        <div class="col-4">
                            <span class="float-left">Total : 140 Kategori</span>
                        </div>
                        <div class="col-4">
                            <span>Manajemen Kategori Baju</span>
                        </div>
                        <div class="col-4">
                            <a href="../../admin/kategori_baju/tambah_kategori_baju.html"
                                class="btn btn-success btn-sm float-right mb-3">
                                Tambah Data
                            </a>
                            <button class="btn btn-dark btn-sm mb-3" data-toggle="collapse"
                                data-target="#collapseCariKategoriBaju" aria-expanded="true"
                    ...
                    <div id="accordion">
                        <div class="card">
                            <div id="collapseCariKategoriBaju" class="collapse" aria-labelledby="headingOne"
                    ...
                    <tbody class="bg-light">
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="../../admin/kategori_baju/edit_kategori_baju.html" class="btn btn-warning"><i
