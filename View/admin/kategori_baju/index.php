        ...
        <div class="card text-center mt-3 border border-light" style="width: 100%;">
            ...
            <ul class="list-group list-group-flush">
                <li class="list-group-item text-dark font-weight-bold">
                    <div class="row">
                        <div class="col-4">
                            <span class="float-left">Total : <?php echo $jumlah; ?> Kategori</span>
                        </div>
                        <div class="col-4">
                            <span>Manajemen Kategori Baju</span>
                        </div>
                        <div class="col-4">
                            <a href="index.php?view=admin&page=kategoriBaju&aksi=tambah" class="btn btn-success btn-sm float-right mb-3">
                                Tambah Data
                            </a>
                            <button class="btn btn-dark btn-sm mb-3" data-toggle="collapse" data-target="#collapseCariKategoriBaju" aria-expanded="true" aria-controls="collapseOne">
                                Cari
                            </button>
                        </div>
                    </div>
                    <div id="accordion">
                        <div class="card">
                            <div id="collapseCariKategoriBaju" class="collapse" aria-labelledby="headingOne" data-parent="#accordion">
                                <form action="index.php?view=admin&page=kategoriBaju&aksi=filter" method="post">
                                    <div class="card-body bg-dark text-white font-weight-normal">
                                        <div class="row">
                                            <div class="col-10">
                                                <div class="form-group row">
                                                    <label for="inputKategoriBaju" class="col-sm-5 col-form-label">Cari
                                                        Kategori Baju</label>
                                                    <div class="col-sm-5">
                                                        <select class="custom-select" name="kategori">
                                                            <option selected>Kategori Baju</option>
                                                            <?php foreach ($dataKategoriBaju as $rowDataKategoriBaju) : ?>
                                                                <option><?php echo $rowDataKategoriBaju['kategoriBaju']; ?></option>
                                                            <?php endforeach; ?>
                                                        </select>
                                                    </div>
                                                </div>
                ...
                <table class="table table-hover table-bordered">
                    <thead class="thead-dark text-center">
                        <tr>
                            ...
                            <th scope="col" style="width: 70%;">Kategori Baju</th>
                            <th scope="col" style="width: 20%;">Aksi</th>
                        </tr>
                    </thead>
                    <tbody class="bg-light">
                        <?php $no = 1;
                        foreach ($dataKategoriBaju as $rowDataKategoriBaju) : ?>
                            <tr>
                                <th scope="row" class="text-center"><?php echo $no++; ?>.</th>
                                <td><?php echo $rowDataKategoriBaju['kategoriBaju']; ?></td>
                                <td class="text-center">
                                    <a href="index.php?view=admin&page=kategoriBaju&aksi=edit&id=<?php echo $rowDataKategoriBaju['idKategoriBaju']; ?>" class="btn btn-warning"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
